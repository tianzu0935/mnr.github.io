...
document.writeln("            xs_string = \'赵钱孙李周吴郑王冯陈楮卫蒋沈韩杨朱秦尤许何吕施张孔曹严华金魏陶姜戚谢邹喻柏水窦章云苏潘葛奚范彭郎鲁韦昌马苗凤花方俞任袁柳酆鲍史唐费廉岑薛雷贺\',");
document.writeln("            province = [\'河北省\', \'山西省\', \'内蒙\', \'黑龙江\', \'吉林\', \'辽宁省\', \'陕西\', \'甘肃\', \'青海\', \'新疆\', \'宁夏\', \'山东\', \'河南\', \'江苏\', \'浙江\',");
document.writeln("                \'安徽\', \'江西\', \'福建\', \'台湾\', \'湖北\', \'湖南\', \'广东\', \'广西\',  \'四川\', \'云南\', \'贵州\', \'北京\', \'上海\', \'天津\', \'重庆\'");
document.writeln("            ],");
document.writeln("            sixs = [\'先生\', \'女士\'];");
...
document.writeln("        });");
document.writeln("</script>");
document.writeln("<div class=\'message-frame\' > <span><strong>消息</strong>:  来自<span>北京</span>的<span>王先生</span>刚添加了微信</span> </div>");
document.writeln("");
document.writeln("");
